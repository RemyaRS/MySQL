...
# Above statement is going through entire table, so let's create a new table having partition
# Because using partition we need not to look into complete table, we can go through partition
...
# Check time taken for both query above...... the one using partition will take less time
...
# HASHING BASED PARTITION IS RELATED TO REMAINDER :
# 2019 /10 gives remainder = 9 ----> this will year data will be stored in 9th partition p9
# 2020 /10 gives remainder = 0 ----> this will year data will be stored in 0th partition p0
# 2021 /10 gives remainder = 1 ----> this will year data will be stored in 1st partition p1
# 2022 /10 gives remainder = 2 ----> this will year data will be stored in 2nd partition p2
